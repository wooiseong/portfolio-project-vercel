...
2. Due to budget constraint, I do not apply for MySQL hosting. The feedback cannot be stored in mySql database. I wrote a simple response in nodeJS. You can refer to <a href="https://github.com/wooiseong/portfolio-backend-on-vercel">portfolio-backend-on-vercel</a>. For nodeJS file connected to local mySQL database:  <a href="https://github.com/wooiseong/portfolio-nodeJS-mySql">portfolio-nodeJS-mySql</a>
